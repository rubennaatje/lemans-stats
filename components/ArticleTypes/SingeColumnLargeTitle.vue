    ...
    <div class="ph3 ph4-m ph5-l">
      ...
      <div class="measure db center f5 f4-ns lh-copy">
        ...
        <p>
          ...
          Shortly after closing, a fire in 1966 destroyed the building while it
        ...
        <p>
          ...
          at sea level, could be switched on from a control room and could fill
          the tanks at a rate of 6,000 US gallons a minute, recycling all the
          water in five hours.
        </p>
      </div>
    </div>
